...
func cmd() *cobra.Command {
	...
	c.Flags().StringVar(&a.redirectURI, "redirect-uri", "http://127.0.0.1:31000/callback", "Callback URL for OAuth2 responses.")
	c.Flags().StringVar(&issuerURL, "issuer", "http://127.0.0.1:32000/dex", "URL of the OpenID Connect issuer.")
	c.Flags().StringVar(&listen, "listen", "http://0.0.0.0:31000", "HTTP(S) address to listen at.")
